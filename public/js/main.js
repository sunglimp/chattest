...
function showNotification(type, text) {
    ...
    if (type === "success") {
        $('.notifier__icon').addClass('notifier__success').html('<i class="fas fa-check"></i>');
    } else if (type === "warning") {
        $('.notifier__icon').addClass('notifier__warning').html('<i class="fas fa-times"></i>');
    } else if (type === "info") {
...
// $(document).on('click', '#multiple-checkbox', function(event) {
//   // alert();
//   event.preventDefault();
//   event.stopImmediatePropagation();
// });
