...
$(document).ready(function () {
  ...
  activeSideBar();
  var agentId = initDashboard(); //Click on 7, 15, 30 day tab
...
function initDashboard() {
  ...
  var agentId = params.get("agentIds");
...
function _timer(callback) {
  ...
  this.start = function (interval) {
    if (time == 0 || time == undefined || time == null) {
      ...
      console.log($('.hour').html()); // console.log("second :" +$('.second').html() +"Minute :"+ $('.minute').html() + "Hour :"+$('.hour').html());
    }
